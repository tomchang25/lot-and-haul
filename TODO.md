...
- [customer_sell] Add a night-level customer match floor so open shop usually has actionable buyers without restoring tag-level owned-storage bias — see `dev/docs/plans/customer_sell_match_floor.sketch.md`
