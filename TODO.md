...
- [director_split] Split Director into presentation + orchestration autoloads, document testing taxonomy — see `dev/docs/plans/director_split_and_testing_taxonomy.sketch.md`
