...
const REPAIR_RARITY_FACTOR: Dictionary = {
    ...
    Economy.Rarity.UNCOMMON: 0.9,
    Economy.Rarity.RARE: 0.8,
    Economy.Rarity.EPIC: 0.7,
    Economy.Rarity.LEGENDARY: 0.6,
}
...
const RESTORE_RARITY_FACTOR: Dictionary = {
    Economy.Rarity.COMMON: 1.0,
    Economy.Rarity.UNCOMMON: 0.8,
    Economy.Rarity.RARE: 0.6,
    Economy.Rarity.EPIC: 0.4,
    Economy.Rarity.LEGENDARY: 0.2,
}
...
static func apply_repair(entry: ItemEntry) -> void:
    ...
    var rarity_factor: float = REPAIR_RARITY_FACTOR[entry.rarity]
...
static func apply_restore(entry: ItemEntry, restoration_attr: int) -> void:
    ...
    var rarity_factor: float = RESTORE_RARITY_FACTOR[entry.rarity]
