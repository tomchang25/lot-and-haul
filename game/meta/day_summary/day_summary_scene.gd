...
@onready var _income_group: VBoxContainer = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/IncomeGroup
@onready var _onsite_label: Label = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/IncomeGroup/OnsiteLabel

@onready var _living_label: Label = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/ExpensesGroup/LivingLabel
@onready var _entry_fee_label: Label = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/ExpensesGroup/EntryFeeLabel
@onready var _fuel_label: Label = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/ExpensesGroup/FuelLabel
@onready var _paid_label: Label = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/ExpensesGroup/PaidLabel

@onready var _actions_group: VBoxContainer = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/ActionsGroup
@onready var _actions_list: VBoxContainer = $RootVBox/PanelCenter/OuterPanel/Margin/ContentVBox/ActionsGroup/ActionsList
