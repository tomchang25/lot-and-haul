...
# that later entities need for cross-references. anchor_spec and clue_spec must
# precede item_spec so their UIDs are available for ExtResource links in item .tres files.
REGISTRY = [
    perk_spec,
    super_category_spec,
    category_spec,
