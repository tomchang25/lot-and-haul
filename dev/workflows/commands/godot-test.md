...
1. **Snapshot/setup** — Build the safe `/tmp` snapshot exactly as documented in `dev/agent_rules/godot_test_check.md`. Copy gitignored test fixtures as documented in `dev/agent_rules/godot_tests.md` before running unit tests.
