...
- `workflows/`: development process artifacts. Use this for plan, implementation spec, sketch, ship, stage-review, and other rules for how work moves from idea to implementation.
